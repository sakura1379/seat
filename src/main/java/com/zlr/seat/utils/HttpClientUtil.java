...
public class HttpClientUtil {
    ...
    public static String doGet(String url, Map<String,String> params) {
        ...
        try {
            log.info(String.valueOf(nameValuePairs.isEmpty()));
            String paramsStr = nameValuePairs.isEmpty() ? "" : "?" + EntityUtils.toString(new UrlEncodedFormEntity(nameValuePairs, "UTF-8"));
            ...
            if(params != null && params.containsKey("access_token")){  //github改变了请求方式
                httpGet.setHeader("Authorization","token "+params.get("access_token"));
            }
            ...
            if (response.getStatusLine().getStatusCode() != HttpStatus.OK.value()){
                ...
                throw new GlobleException(ResultStatus.THIRD_REQUEST_ERROR);
            }
        }catch (Exception e) {
            log.error("请求异常:{0}", e);
            throw new GlobleException(ResultStatus.THIRD_REQUEST_ERROR);
